...
It makes more sense to wrap them around because if you just stacked them all in one column they would get smushed and same with if we only had one row. You would barely, or not at all, be able to see the data. This laout made the graphs more square like which allows me to see the most data.
